...
const Cookie = () => {
  ...
  const handleCookie = () => {
    setCookie("besecCookie", "besec", 365);
    setCloseCookie(true);
  };

  if (checkCookie("besecCookie") || closeCookie) return;

  return (
    <div class="fixed bottom-0 start-0 z-[60] sm:max-w-xl w-full mx-auto p-6">
      <div class="p-4 bg-white border border-gray-200 rounded-xl shadow-sm">
        <div class="flex gap-x-5">
          <svg
            class="hidden sm:block shrink-0 w-20"
            width="72"
            height="63"
            viewBox="0 0 72 63"
            fill="none"
          ...
          <div class="grow">
            ...
            <p class="mt-2 text-sm text-gray-600">{cookieData.description}</p>
